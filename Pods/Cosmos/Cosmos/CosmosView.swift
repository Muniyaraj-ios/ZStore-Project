...
@IBDesignable open class CosmosView: UIView {
  ...
  */
  ...
  @IBInspectable open var starSize: Double = CosmosDefaultSettings.starSize {
    didSet {
      settings.starSize = starSize
    }
  }
  
  @IBInspectable open var filledColor: UIColor = CosmosDefaultSettings.filledColor {
    didSet {
      settings.filledColor = filledColor
    }
  }
  
  @IBInspectable open var emptyColor: UIColor = CosmosDefaultSettings.emptyColor {
    didSet {
  ...
  @IBInspectable open var updateOnTouch: Bool = CosmosDefaultSettings.updateOnTouch {
    didSet {
  ...
  @IBInspectable open var filledImage: UIImage? {
    didSet {
